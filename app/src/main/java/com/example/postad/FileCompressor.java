...
/**
 * Created by Jony on 11/5/20.
 */

/** we create an image compressor that extends from uri to compress images from gallery, and from bytes to compress
 * images took from camera*/

/**all the code to create this fileCompressor was taken from https://androidwave.com/capture-image-from-camera-gallery/*/
//todo apply changes to do the image compressor in the background thread to dont overcharge the main thread
